...
public class BoardController implements BoardControllerDocs {
	...
	@Override
	@GetMapping
	public ResponseEntity<ResponsePage<BoardSummary>> getBoards(@RequestParam(defaultValue = "1") int page,
		...
		List<BoardSummary> boardSummaries = BoardSummary.from(boards.getContent());
		ResponsePage<BoardSummary> res = ResponsePage.from(boardSummaries,
														   page,
